...
public class ArrayEquality {
    ...
    public static void main(String[] args) {
        ...
        nombres[1]=15;
        nombres[2]=20;
        System.out.println("bases_Java.Affichage nombre1:"+ Arrays.toString(nombres));
        int [] nombres2=nombres;
        nombres2[0]=33;
        System.out.println("bases_Java.Affichage tableau nombre1 apres creation de 2:"+ Arrays.toString(nombres));
