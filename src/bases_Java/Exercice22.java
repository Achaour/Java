...
public class Exercice22 {
    public static void main(String[] args) {
      ...
      //  System.out.println(Arrays.toString(words));
        ...
        System.out.println("Le pourcentage d'adresse email en hotmail est de " +100*sommeHotmail/(sommeGmail+sommeYahoo+sommeHotmail)+"%");
        System.out.println("Le pourcentage d'adresse email en gmail est de "  + 100*sommeGmail/(sommeGmail+sommeYahoo+sommeHotmail)+"%");
        System.out.println("Le pourcentage d'adresse email en yahoo est de " +100*sommeYahoo/(sommeGmail+sommeYahoo+sommeHotmail)+"%");
